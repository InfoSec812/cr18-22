...
@Entity
@Table(name = "indicators_course_of_actions", schema = "example_database", catalog = "")
public class IndicatorsCourseOfActions {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        IndicatorsCourseOfActions that = (IndicatorsCourseOfActions) o;
        return id == that.id &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, stixIndicatorId, courseOfActionId, createdAt, updatedAt, guid, userGuid, transferFromLow);
    }
}
